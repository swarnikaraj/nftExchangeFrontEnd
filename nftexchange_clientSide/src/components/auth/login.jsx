...
export const Login = () => {
  ...
  return (
    <>
      <div
        onClick={onClick}
        className="p-2 mx-auto lg:w-96  cursor-pointer shadow-[0_35px_60px_-10px_rgba(101,92,138,0.6)] m-4"
      >
        <h1 className="text-base ">Meta Mask Wallet is Required</h1>

        <div>
          <div className="flex whitespace-pre-line p-2 bg-white text-black max-h-full w-full rounded-lg mx-auto  ">
            <div>
              <svg
            ...
            <div className="text-black font-extrabold pl-2 ">Meta mask</div>
          </div>
        </div>
      </div>
    </>
