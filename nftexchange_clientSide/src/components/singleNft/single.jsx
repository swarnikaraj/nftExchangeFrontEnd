  ...
  return (
    <>
      <div className="container flex flex-wrap items-center justify-between w-full mx-auto  sm:overflow-x-hidden md:overflow-x-hidden">
          ...
          <div className="mx-auto 2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9  ">
            <div className="flex flex-col items-center justify-center gap-8 lg:flex-row">
              <div className="items-center w-full sm:w-96 md:w-8/12 lg:w-6/12">
                ...
                <div className="grid grid-cols-4 gap-4 mt-6 leading-5 lg:leading-6 sm:grid-cols-2 md:grid-cols-3">
                  {attributes?.map(({ trait_type, value }) => (
                    <div
                      className="p-4  shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6)] hover:bg-[rgb(101,92,138)] bg-transparent"
                      key={uuidv4()}
                    >
              ...
              <div className="flex flex-col w-full gap-4 sm:w-96 md:w-8/12 lg:w-6/12 lg:flex-row lg:gap-8 sm:gap-6">
                <div className="flex items-center justify-center w-full bg-transparent lg:w-full">
                  {image && <img src={image} alt="Nft image" />}
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="overflow-x-auto overflow-y-scroll max-h-60">
                    <table className="w-full whitespace-nowrap">
                      <thead className="text-semibold">
                        <tr
                          className="h-16 text-xl leading-none text-black text-semibold shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6)]"
                          key={uuidv4()}
                        >
                          <td className="w-1/2">
                      ...
                      <tbody>
                        {his?.map((item) => (
                          <tr
                            className="h-16 text-sm leading-none text-gray-300 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6)]"
                            key={uuidv4()}
                          >
                            <td className="w-1/2">
                              <div className="flex items-center">
        ...
        {buyPopUp && !bidPopUp && (
          <div
            className="w-1/3 bg-white shadow rounded absolute top-20"
            id="modal"
          >
                ...
                <div className="flex items-center">
                  <div className="pr-2 bg-gray-100 rounded flex items-center justify-between">
                    <select className="w-36 text-xs font-medium leading-3 text-gray-600 appearance-none bg-gray-100 focus:outline-none p-2">
                      <option className="text-xs font-medium leading-3 text-gray-600">
                        Owner
                      </option>
                      <option className="text-xs font-medium leading-3 text-gray-600">
                        Edit access
            ...
            <div className="p-6 flex items-center justify-between">
              <div className="bg-indigo-100 rounded p-3">
                <div className="flex items-center">
                  ...
                  <p className="text-xs pl-3 pr-4 border-r border-indigo-300 leading-3 text-indigo-700">
                    www.figma.com/ksif02984-1..
                  </p>
                  <p className="text-xs font-semibold pl-3 leading-3 text-indigo-700 cursor-pointer">
                    COPY
                  </p>
                </div>
              </div>
              <div>
                <button className="text-xs font-semibold py-3 px-6 bg-indigo-700 rounded focus:outline-none hover:bg-indigo-600 leading-3 text-white">
                  Done
                </button>
              </div>
            </div>
