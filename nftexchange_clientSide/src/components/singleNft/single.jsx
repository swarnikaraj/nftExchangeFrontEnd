  ...
  return (
    <>
      <div className="container flex flex-wrap items-center justify-between w-full mx-auto  sm:overflow-x-hidden md:overflow-x-hidden">
        ...
        {buyPopUp && !bidPopUp && (
          <div className="fixed w-screen h-screen bg-[rgba(0,0,0,0.75)] top-0 bottom-0 left-0 right-0">
            <div
              className="lg:w-1/3 md:1/3 bg-[rgb(101,93,138,0.4)] shadow rounded fixed top-40 left-1/3 "
              id="modal"
            >
